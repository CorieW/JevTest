...
This report retains the aggregate comparison. Per-case traces, snapshots, and the durable spending ledger are local evidence under ignored `artifacts/`; generated example results are not kept in version control.
